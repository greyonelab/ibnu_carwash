...
WashOrder _$WashOrderFromJson(Map<String, dynamic> json) => WashOrder(
  ...
  allStaff: (json['all_staff'] as List<dynamic>?)
      ?.map((e) => Staff.fromJson(e as Map<String, dynamic>))
      .toList(),
  commissionBreakdown: json['commission_breakdown'] as Map<String, dynamic>?,
);
...
Map<String, dynamic> _$WashOrderToJson(WashOrder instance) => <String, dynamic>{
  ...
  'user': instance.user,
  'all_staff': instance.allStaff,
  'commission_breakdown': instance.commissionBreakdown,
};
