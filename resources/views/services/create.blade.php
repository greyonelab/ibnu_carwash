...
@section('title', 'Tambah Layanan - WashManager Pro')
...
<div class="p-6 space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Tambah Layanan</h1>
            <p class="text-slate-600">Tambahkan layanan cuci baru</p>
        </div>
    </div>
        ...
        <form action="{{ route('services.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" id="duration_minutes" name="duration_minutes" value="{{ old('duration_minutes') }}" min="1" required
